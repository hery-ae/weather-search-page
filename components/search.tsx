    ...
    return (
        <form className='mb-8' onSubmit={submit}>
            <div className='flex border-2 border-blue-500 w-full md:w-96'>
                <input className='appearance-none w-full px-1 leading-tight focus:outline-none' type='text' name='term' placeholder='Search the location' autoComplete='off' spellCheck='false' />
